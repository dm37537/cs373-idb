    ...
    def test_getting_jobs(self):
        expected = {
            "Jobs": [
                ...
                {
                  "company_id": 4,
                  "job_description": "Our team is at the intersection of software engineering and digital advertising. This role is for engineers who love to build products and work with partners to realize the full potential of those products. As a Solutions Engineer, you are the engineering lead of your assigned set of partners and are responsible for developing their Facebook technology strategy and executing on it. You will spend 50% of your time working with product engineering teams and writing code. The other 50% you will spend working directly with partners. This is an engineering role with a high bar for problem solving and coding skills. This role is located in our New York, NY office.",
                  "job_id": 16,
                ...
                {
                  "company_id": 4,
                  "job_description": "We are looking for someone that has strong experience developing user interfaces for applications on Android using Android SDK. If you are interested in joining a world-class team of passionate people and industry veterans who like to work hard and play hard, we look forward to hearing from you soon!",
                  "job_id": 17,
                ...
                {
                  "company_id": 4,
                  "job_description": "Facebook is seeking a Speech Recognition Research Scientist to join our research team in Menlo Park. The ideal candidate will have research experience developing speech recognition systems in different languages. Individuals in this role should be experts in acoustic modeling, including discriminative training, neural networks, and machine learning, and have experience working on large quantities of data. The candidate will help Facebook conduct research that support naturally spoken input in more than 70 languages.",
                  "job_id": 25,
                ...
                {
                  "company_id": 5,
                  "job_description": "You will work on cutting-edge problem and participate in the engineering life-cycle at Twitter, including designing distributed systems, writing production code, conducting code reviews and working alongside our infrastructure and reliability teams. You will be equally comfortable doing incremental quality work and also building brand new systems to enable future quality improvements. ",
                  "job_id": 30,
                ...
                {
                  "company_id": 5,
                  "job_description": "Brainstorm and implement products that improve the lives of all Twitter employees. Rapidly prototype new ideas with your teammates. Develop and maintain full stack web applications.",
                  "job_id": 33,
                ...
                {
                  "company_id": 5,
                  "job_description": "We are looking for a number of passionate, talented, entrepreneurial engineers to join the team in New York to help us build the foundations for our deep learning platform.",
                  "job_id": 38,
                ...
                {
                  "company_id": 5,
                  "job_description": "You will build web applications for our users, partners, and team. Those applications can range from business-critical internal tools to the core architecture of Twitter.com and our mobile website, with opportunities to work with a variety of languages and technologies.",
                  "job_id": 41,
                ...
                {
                  "company_id": 6,
                  "job_description": "Lead technical customer pre-sales discussions/engagements as they relate to integration solutions with the LinkedIn Talent Solutions platform. Own and manage customer engagements through the entire implementation, delivery and support lifecycle. Manage technical partner relationships and continue to build on top of existing integrations and processes. Partner with different internal cross functional groups to communicate/escalate customer technical issues, help drive/influence product roadmap decisions based on customer/partner feedback, and implement internal tools/solutions to help demonstrate product value propositions. Develop and deliver on-going internal sales training and education of Talent Solutions products and services. Contribute to the development and sharing of best practices. Establish yourself as a Subject Matter Expert. Develop and maintain centralized content for customers, partners, and internal teams.",
                  "job_id": 42,
                ...
                {
                  "company_id": 6,
                  "job_description": "The Business Analytics team is looking for data junkies who love turning data into gold and who want to make an impact. You will have the opportunity to help build data products and own analytics in the area of Mobile, Social Advertising, Engagement, etc. You will be working closely with monetization product managers and engineers to drive the business. LinkedIn s reputable internship program is known for plentiful activities and a fun Intern Hackathon. Join us this summer!",
                  "job_id": 46,
                ...
                {
                  "company_id": 7,
                  "job_description": "IBM is looking for an Information Technology Services - Developer who performs moderately complex application development in the design, development, analysis, implementation/integration and testing of moderately complex programming systems supporting key business activities. They will design, code, test, and provide ongoing support of an application or an application component. This role considers performance, serviceability, usability and maintainability while performing application development tasks. The Developer defines, researches, integrates or develops, releases, and maintains reusable application components on one or more platforms with proven technologies. This role solves problems based on precedent and procedures and follows standard application development methodology. Required Bachelor s Degree Basic knowledge in C++ Basic knowledge in Unix and/ or Linux Basic knowledge in Oracle Basic knowledge in WebSphere Basic knowledge in DB2 Basic knowledge in Java 2 Platform, Enterprise Edition (J2EE) Basic knowledge in Structured Query Language (SQL) Basic knowledge in Javascript Basic knowledge in JavaServer Pages (JSP) Basic knowledge in Analytical & Problem Solving English: Basic knowledge ",
                  "job_id": 56,
                ...
                {
                  "company_id": 9,
                  "job_description": "Qualifications Responsibilities * Design and implement production grade software at cloud scale * Partner with QE/Test, Support, Operations and Product management to ensure high quality software releases per schedule * Evaluate technical aspects of other developer s designs and proposals * Provide estimates for development effort The ideal candidate will have the following characteristics: * 5+ years of experience in software product development (design, coding, system engineering, object oriented programming) 5+ years hands on python development * Development of RESTful APIs using the Python language * Strong knowledge of the Linux operating system * Highly desired: experience with Cloud Computing * Ability to quickly pick up new technologies * Work independently without needing lot of input, self-driven. * Experience with contributing to open source code is a plus",
                  "job_id": 71,
                ...
                {
                  "company_id": 3,
                  "job_description": "Amazon Web Services (AWS) in Seattle is actively seeking a Senior Software Developer to help create a brand new service. This is an excellent opportunity to join a cutting edge team developing customer focused products. Relocation assistance is available. Join AWS to help mobile developers build great cloud-backed apps! As a member of the AWS Mobile team, you will develop services which cater to the needs of mobile developers who build apps for iOS, Android, Kindle, and the mobile web.We believe that cloud-backed mobile and device applications are a big deal, and our customers are developers who think likewise. We are driven to support our customers in their endeavors, providing software and services to help them use AWS as the foundation for their apps. This is a unique opportunity to influence the mobile app development community in a big way.This role will be responsible for building web service APIs that interact with mobile applications.",
                  "job_id": 78,
                  "job_title": "Software Developer - Amazon Web Services",
                  "link": "http://www.amazon.jobs/jobs/295855/software-developer-amazon-web-services-new-mobile-service",
                  "location_id": 2
                },
                {
                    "company_id": 3,
                    "job_description": "We re looking for product-aware engineers who are thoughtful, responsible and passionate builders who appreciate user experience. We re looking for someone who is not only well versed in iOS development, but also has a strong understanding of good UX and isn t afraid to get their hands dirty in backend code. We believe that great product people use lots of products, so if you re an active user of Goodreads, we are listening. Come to join us to shape the future how people find their next favorite book.",
                    "job_id": 79,
